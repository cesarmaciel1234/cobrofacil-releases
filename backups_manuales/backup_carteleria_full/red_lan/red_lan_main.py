...
class Admin6RedLan(QWidget):
    ...
    def _build(self):
        ...
        # Instanciar el panel compartido indicando que NO se deben mostrar los botones de administrador (ya que es Cartelería)
        self.panel = SharedRedLanPanel(self, show_admin_buttons=False)
