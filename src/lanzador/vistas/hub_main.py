...
class PerfilPantalla(QDialog):
    ...
    def _setup_ui(self):
        ...
        try:
            from src.lanzador.moleculas.updater_badge import SmartLauncherUpdater
        ...
        # Título principal
        title = QLabel("Bienvenido a CobroFacil")
    ...
    def _lanzar_proceso_autonomo(self, rol):
        ...
        from src.lanzador.cerebro.process_spawner import spawn_role_process
