...
class DisplayPromoTV(QFrame):
    ...
    def _init_subcontenedores(self):
        ...
        self.marketing_lay.setContentsMargins(10, 10, 10, 10)
        ...
        self.marketing_container.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.MinimumExpanding)
