...
class DisplayPromoTV(QFrame):
    ...
    def _init_subcontenedores(self):
        ...
        # 3. Rating y Marketing (Sub-contenedor horizontal para ahorrar espacio vertical)
        self.marketing_container = QFrame()
        self.marketing_container.setObjectName("marketing_container")
        self.marketing_lay = QHBoxLayout(self.marketing_container)
        self.marketing_lay.setContentsMargins(10, 5, 10, 5)
        self.marketing_lay.setSpacing(15)
        self.marketing_lay.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.lbl_estrellas = QLabel("⭐⭐⭐⭐⭐")
        self.lbl_estrellas.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        self.lbl_marketing = QLabel("")
        self.lbl_marketing.setAlignment(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
