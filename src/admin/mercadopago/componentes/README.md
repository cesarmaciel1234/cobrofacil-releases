...
`run()` la primera vuelta marca los pagos ya aprobados y no avisa. Después consulta cada 2 segundos y emite `new_payment` si el cobro es de esta cuenta, está aprobado y tiene menos de 180 segundos. Un 401 emite `error_signal` y frena el hilo.
