        ...
        class WorkerPrecarga(QThread):
            ...
            def run(self):
                ...
                try:
                    ...
                    self.finished.emit(True, f"Se insertaron {len(values)} productos exitosamente.")
...
class Admin1Inventario(QWidget):
    ...
    def _setup_ui(self):
        ...
        for b in [self.btn_nuevo, self.btn_modif, self.btn_eliminar, self.btn_importar, self.btn_exportar, self.btn_precarga, self.btn_deptos]:
            tl.addWidget(b)
        tl.addStretch()
