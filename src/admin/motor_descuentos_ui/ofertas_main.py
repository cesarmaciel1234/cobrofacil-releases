...
from src.admin.motor_descuentos_ui.componentes.tabla_ofertas import TablaOfertas
from src.admin.motor_descuentos_ui.componentes.creador_promociones import CreadorPromociones
...
class Admin2Ofertas(QWidget):
    ...
    def _gestionar_combos(self):
        from src.admin.motor_descuentos_ui.componentes.dialogo_combos import DialogoCombos
