...
from src.admin.inventario.componentes.panel_categorias import PanelCategorias
from src.admin.inventario.componentes.catalogo_productos import CatalogoProductos
