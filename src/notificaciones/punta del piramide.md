...
Un solo texto en la franja, y solo si acaba de pasar un cobro o el cajón está abierto. Urgencia de stock, stock bajo y exceso de dinero se juntan en un solo punto del cabezal. Rojo si alguna es urgente, ámbar si solo conviene retirar o hay stock bajo. Al pasar el mouse sale un aviso con el detalle de todas, incluido el monto. Al sacar el mouse, desaparece.
