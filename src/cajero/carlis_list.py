...
class ProductCard(QFrame):
    ...
    def setup_ui(self):
        ...
        self.lbl_nombre.setStyleSheet("font-size: 18px; font-weight: bold; color: #FFF; background: transparent; border: none;")
        
        self.lbl_detalles = QLabel(f"Código: {self.data['id']} | Cantidad: {self.data['cant']:.3f}")
        self.lbl_detalles.setStyleSheet("font-size: 13px; color: #AAA; background: transparent; border: none;")
        ...
        self.lbl_precio.setStyleSheet("font-size: 14px; color: #888; alignment: right; background: transparent; border: none;")
        
        self.lbl_subtotal = QLabel(f"${self.data['subtotal']:.2f}")
        self.lbl_subtotal.setStyleSheet("font-size: 24px; font-weight: bold; color: #00FF00; alignment: right; background: transparent; border: none;")
