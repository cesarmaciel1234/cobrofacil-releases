...
Lo consulta el último monto. Si el cobro reciente ya tiene ticket, no se muestra: el cartel dice que no hay transferencia nueva. Al guardar la venta, `post_cobro` llama `asociar` con el id de la venta.
