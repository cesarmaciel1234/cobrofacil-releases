...
## 🏁 5. CIERRE Y AUDITORÍA (F4 / F12)
*   [ ] **Cierre Ciego**: Como cajero, presione **F4** para realizar un cierre. Ingrese un monto físico diferente al esperado por el sistema. Verifique que el ticket de arqueo muestre la diferencia y que la app se **reinicie al login** inmediatamente.
*   [ ] **Reporte de Alertas**: Como admin, presione **F12** o entre a la pestaña de Cierre Z y verifique que la tarjeta **"Alertas Seguridad"** muestre el número exacto de aperturas con llave que realizó durante las pruebas anteriores.
